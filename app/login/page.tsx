...
const redirect = encodeURI(process.env.REDIRECT_URI!)
const loginUrl = `https://discord.com/oauth2/authorize?client_id=1467492125191966780&response_type=code&redirect_uri=${redirect}&scope=email+identify+guilds.join+openid+guilds`
